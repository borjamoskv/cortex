...
def seed():
    ...
    for day_offset in range(days_to_simulate, -1, -1):
        ...
        day_start = current_date_base.replace(hour=int(start_hour), minute=int((start_hour % 1) * 60), second=0, microsecond=0)
        ...
        for block in SCHEDULE:
            ...
            while current_time < block_end and current_time < NOW:
                ...
                lang = "text"
                if entity.endswith(".py"): lang = "python"
                elif entity.endswith(".js") or entity.endswith(".tsx"): lang = "javascript"
                elif entity.endswith(".md"): lang = "markdown" 
                elif entity.endswith(".css"): lang = "css"
